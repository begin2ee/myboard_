...
public class CommentController {
    ...
    public ResponseEntity<List<CommentReqDto>> save(@Valid @RequestBody CommentReqDto commentDTO) { // 유효성 검증 추가
...
//        return new ResponseEntity.ok(commentDTOList, HttpStatus.OK);
